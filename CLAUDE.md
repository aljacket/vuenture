...
4. **Location/timezone is permissive.** F2 accepts anything remote-compatible with Spain/CET: EU, EMEA, "European hours", worldwide. Rejects US-only, UK-only, APAC, LATAM-only, relocation-required. Spanish-language (Spain/LATAM-Spanish) roles are also in scope — Alfonso speaks Spanish C1. Italian market is NOT in scope (dropped Apr 2026).
